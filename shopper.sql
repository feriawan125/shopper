...
--
-- Host: localhost
-- Generation Time: Jan 17, 2021 at 09:18 PM
...
(24, 'ghi', 'ghi@ghi.com', '031', 'admin', 'ghi', '202cb962ac59075b964b07152d234b70', NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, NULL, NULL, NULL);
...
--
ALTER TABLE `barang`
  MODIFY `KodeBarang` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
...
--
ALTER TABLE `pemasok`
  MODIFY `KodePemasok` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
